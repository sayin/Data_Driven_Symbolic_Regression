...
burgData = pd.read_csv("./../../../data_gen/clean/data/burgerw_data.csv",  encoding='utf-8')   

# In[46]:

msk = np.random.rand(len(burgData)) < 0.8
train = burgData[msk]
holdout = burgData[~msk]
...
#gep.export_expression_tree(best_ind, rename_labels, 'results/burgW_tree.pdf')
